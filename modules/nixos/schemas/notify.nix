        ...
        options = {
          ...
          tokenFile = lib.mkOption {
            ...
            description = ''
              ...
              provisions it at the default path. A host that only publishes to another host's provider
              points this at its own secret instead. How to read it depends on the publisher's user:
